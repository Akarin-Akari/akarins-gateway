...
document.addEventListener('alpine:init', () => {
    ...
    const translations = {
        en: {
            ...
            'backends.fetch_models': '🔄 Refresh List',
            'backends.fetching': 'Loading...',
            ...
            'clients.reset_defaults': 'Restore Defaults',
            ...
            'msg.models_fetched': "Fetched {count} models from '{key}'",
            'msg.models_fetch_failed': "Fetch models from '{key}' failed: {error}",
            ...
            'msg.client_reset_confirm': 'Restore all client settings to initial defaults? This cannot be undone.',
            'msg.client_reset_success': 'All client settings restored to defaults',
            'msg.client_reset_failed': 'Failed to restore defaults: {error}',
        ...
        zh: {
            ...
            'backends.fetch_models': '🔄 刷新列表',
            'backends.fetching': '加载中...',
            ...
            'msg.models_fetched': "已从 '{key}' 获取 {count} 个模型",
            'msg.models_fetch_failed': "从 '{key}' 获取模型失败: {error}",
            ...
            'msg.client_reset_confirm': '确定要将所有客户端设置恢复为初始默认值吗？此操作不可撤销。',
            'msg.client_reset_success': '所有客户端设置已恢复为默认值',
            'msg.client_reset_failed': '恢复默认设置失败: {error}',
