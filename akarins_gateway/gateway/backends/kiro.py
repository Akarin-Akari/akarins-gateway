...
class KiroGatewayBackend:
    ...
    async def is_available(self) -> bool:
        ...
        try:
            ...
            try:
                ...
                log.warning(f"Kiro Gateway backend health check failed: {e}", tag="GATEWAY")
                return False
    ...
    async def _handle_proxy_streaming_request(
        ...
        try:
            # [DEBUG] 记录请求信息
            log.info(
                f"[KIRO BACKEND] Sending streaming request: url={url}, "
            ...
            # [DEBUG] 记录响应统计
            log.info(
                f"[KIRO BACKEND] Streaming completed: chunk_count={chunk_count}, "
